        ...
        <div class="row">
          ...
          <div class="col-lg-7">
            <div class="p-5">
              ...
              <form action="reg_insert.php" method="post" class="user">
                ...
                <div class="form-group row">
                  ...
                  <div class="col-sm-6">
                    <input type="text"  name="phone" class="form-control form-control-user" id="" placeholder="Phone Number">
                  </div>
                </div>
                <input  name="" type="submit" value="Register Account" class="btn btn-primary btn-user btn-block">
